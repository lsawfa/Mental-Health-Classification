...
def train_model(train_set, val_set, test_set, class_names = [], pretrained_model = 'bert-base-cased', 
                saved_model_file = 'best_model_state.pt', saved_history_file = 'history_file.json', epochs = 40, max_len = 256, batch_size = 8):
...
def test_dataset(test_set, train_set, val_set, class_names = [],
                     pretrained_model = 'bert-base-cased', saved_model_file = 'best_bert_model.pt',
...
def predict_dataset(dataset, class_names, classifier_type = 'category',
                    ...
                    model_file_name = 'best_bert_model_state_category_string.pt',
...
def main(args):
    if (args.mode == 'train'):
        ...
        test_dataset(test_set, train_set, val_set, class_names = class_names,
                     pretrained_model = args.model_name, saved_model_file = 'best_bert_model.pt',
