    ...
    for epoch_i in range(0, num_train_epochs):
        ...
        if (val_result['f1_macro'] > best_train_metric):
            ...
            torch.save({'dataset': final_dataset,
                        ...
                        }, 'model_' + model_name.replace('/','_') + '.pt')  
...
def predict_dataset(saved_model_name = 'gan_bert_best_model.pt', test_filename = 'Dataset/test.json',
...
if __name__ == "__main__":
    ...
    parser.add_argument('--model_path', type=str, default='model_gan-bert-base-cased.pt')
...
# python gan.py --mode "test" --model_path "model_gan-bert-base-cased.pt"  --test_file "dataset/test.json"